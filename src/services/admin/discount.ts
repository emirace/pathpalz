...
export const createDiscount = async (
  data: ICreateDiscountRequest,
): Promise<ICreateDiscountReponse> => {
...
export const updateDiscount = async ({
  ...
  const response = await trainingClient.patch(
    `/admin/update/discounts/${discountId}`,
    data,
  );
  return response.data;
};
...
export const deleteDiscount = async (
  ...
  const response = await trainingClient.delete(
    `/admin/delete/discounts/${discountId}`,
  );
  return response.data;
};
...
export const getDiscountCodes = async (): Promise<{
  data: IDiscountCodeResponse;
}> => {
  const response = await trainingClient.get(`/admin/discounts`);
  return response.data;
};

export const getDiscountCode = async (id: string) => {
  const response = await trainingClient.get(`/admin/discounts/${id}`);
  return response.data;
};
