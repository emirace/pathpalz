  ...
  const stats = [
    {
      ...
      icon: <BookOpen className="text-teal" />,
      color: "bg-teal/10",
    },
    {
      name: "Completed",
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.name}
            className="bg-white p-6 rounded-3xl border border-gray-100 flex items-center gap-5 shadow-sm hover:shadow-md transition-all"
          >
            <div
          ...
          <div className="space-y-4">
            {enrollments?.slice(0, 3).map((item) => (
              <div
                ...
                className="flex items-center justify-between p-4 rounded-2xl hover:bg-gray-50 transition-colors border border-gray-50"
              >
          ...
          <div className="relative z-10 h-full flex flex-col items-start justify-between space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-white/60 text-sm max-w-xs">
                Explore more tracks curated just for your career goals.
              </p>
            </div>
            <Link
              href="/training"
