...
const CoreValues = () => {
  const values = [
    {
      title: "Passion",
      description: "Heart in everything we build and teach.",
      icon: (
    ...
    {
      title: "Tenacity",
      description: "Relentless pursuit of quality and solutions.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      description: "We own our process and our promises.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      title: "Growth",
      description: "Continuous evolution for us and our clients.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
